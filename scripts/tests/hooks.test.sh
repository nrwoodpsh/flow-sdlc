...
#   check-drift-hook.sh  훅이 안 도는 상태를 알아채나  ← 테스트가 0건이 되기 쉬운 자리다
#
...
# ══════════════════════════════════════════════════════════
# check-drift-hook.sh — **테스트가 0건이 되기 쉬운 자리다.**
...
# 경로가 틀리면 훅이 조용히 안 돈다. "약속만 있고 기계는 없다"의 배선 판이다.
# ══════════════════════════════════════════════════════════
head_ "hooks.json 배선"
